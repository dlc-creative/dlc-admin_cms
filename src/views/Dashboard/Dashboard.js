  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" sm="6" lg="3">
            <Widget04 icon="icon-user-follow" color="success" header={this.props.clients.length} value="25" invert>Clients</Widget04>
          </Col>
          <Col xs="12" sm="6" lg="3">
            <Widget04 icon="icon-user-follow" color="info" header={this.props.projects.length} value="25" invert>Projects</Widget04>
          </Col>
          <Col xs="12" sm="6" lg="3">
